...
class UserModel(Base):
    ...
    driver_profile = relationship("DriverProfileModel", back_populates="user")
    dispatched_rides = relationship("RideModel", foreign_keys="RideModel.dispatcher_id", back_populates="dispatcher")
    driver_rides = relationship("RideModel", foreign_keys="RideModel.driver_id", back_populates="driver")
